        ...
        <div>
            <div className='h-screen bg-[#f5f8fc] flex items-center justify-center'>
                <div className='w-full text-center'>
                    <p className='text-blue-600 p-1 m-auto rounded-full bg-blue-100 w-2/12 gap-4 flex items-center flex-row  justify-center text-sm'> 🔄 Our Proven Process </p>
            ...
            <div className='w-11/12 m-auto mt-12 pb-12'>
                <div className='flex items-center justify-between'>
                    <div className='border py-5 cursor-pointer w-6/12 px-6 hover:shadow-lg rounded-lg'>
