        ...
        <div>
            <div className='h-screen bg-[#f5f4ff] flex items-center justify-center'>
                <div className='w-full text-center'><br /><br /> <br />
                    <p className=" bg-gradient-to-br from-indigo-500 to-purple-500 m-auto  text-white font-semibold w-20 h-20 rounded-xl flex items-center justify-center shadow-md hover:opacity-90 transition">
                        <FontAwesomeIcon icon={faUserFriends} size='2x' />
                    </p> <br />
                    <p className='text-blue-600 font-semibold p-1 m-auto rounded-full bg-blue-100 xl:w-2/12 lg:w-3/12 sm:w-5/12 w-10/12  gap-4 flex items-center flex-row  justify-center text-sm'> 💼 Consulting & Coaching</p>
                    <h1 className='xl:text-6xl lg:text-5xl sm:text-4xl text-3xl py-2 font-bold leading-tight'>
                        Expert     <span className="bg-gradient-to-br from-indigo-500 to-purple-500 py-1 bg-clip-text text-transparent">
                            Business Coaching
                        </span>
                    </h1>
