        ...
        <div>
            <div className='h-screen bg-gradient-to-r  to-[#007bff10] from-[#00ffd03b] flex items-center justify-center'>
                <div className='w-full text-center'><br /><br /> <br />
                    ...
                    <p className='text-blue-600 p-1 m-auto rounded-full bg-blue-100 w-3/12 gap-4 flex items-center flex-row  justify-center text-sm'> 🧠 Machine Learning & Data Intelligence </p>
            ...
            <div className='text-center w-11/12 m-auto'>
                <h1 className='text-4xl text-gray-600 font-bold mt-12'>ML & Data Services</h1>
