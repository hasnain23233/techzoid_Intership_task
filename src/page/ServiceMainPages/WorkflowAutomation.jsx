        ...
        <div>
            <div className='h-screen bg-green-50  flex items-center justify-center'>
                <div className='w-full text-center'><br /><br /> <br />
                    <p className=" bg-gradient-to-br from-green-600 to-teal-600 m-auto  text-white font-semibold w-20 h-20 rounded-xl flex items-center justify-center shadow-md hover:opacity-90 transition">
                        <FontAwesomeIcon icon={faRoute} size='2x' />
                    </p> <br />
                    <p className='text-green-600 p-1 m-auto rounded-full bg-green-100 xl:w-2/12 lg:w-3/12 sm:w-5/12 w-10/12 gap-4 flex items-center flex-row  justify-center text-sm'> ⚡ AI + Workflow Automation </p>
                    <h1 className='xl:text-6xl lg:text-5xl sm:text-4xl text-3xl py-2 font-bold leading-tight'>
                        Intelligent    <span className="bg-gradient-to-br from-green-600 to-teal-600 py-1 bg-clip-text text-transparent">
            ...
            <div className='text-center w-11/12 m-auto'>
                ...
                <div className="grid xl:grid-cols-3 lg:grid-cols-2 sm:grid-cols-1 text-start gap-4 mt-12 ">
